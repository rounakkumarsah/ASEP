...
import { Cpu, Eye, EyeOff, Check, X, RefreshCw } from "lucide-react";
...
export default function SignupPage() {
  ...
  return (
    <GuestRoute>
      <div className="flex min-h-screen w-full items-center justify-center bg-[#090B0F] py-12 px-4 sm:px-6 lg:px-8 text-[#F5F7FA]">
        <Card className="w-full max-w-lg border border-[#202833] bg-[#0D1117] shadow-xl">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs font-mono font-semibold uppercase text-[#9CA6B5]">First Name</FormLabel>
                        <FormControl>
                          <Input placeholder="Jane" className="border-[#202833] bg-[#090B0F] text-[#F5F7FA]" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs font-mono font-semibold uppercase text-[#9CA6B5]">Last Name</FormLabel>
                        <FormControl>
                          <Input placeholder="Doe" className="border-[#202833] bg-[#090B0F] text-[#F5F7FA]" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs font-mono font-semibold uppercase text-[#9CA6B5]">Company (Optional)</FormLabel>
                      <FormControl>
                        <Input placeholder="Acme Corp" className="border-[#202833] bg-[#090B0F] text-[#F5F7FA]" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                {watchPassword && (
                  <div className="space-y-2 font-mono text-[10px]">
                    ...
                    {/* Rules */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pt-1 text-[#667085]">
                      <div className="flex items-center gap-1.5">
                        {rules.length ? (
                          <Check className="h-3.5 w-3.5 text-[#2DD4A3]" />
                        ) : (
                          <X className="h-3.5 w-3.5 text-[#667085]/50" />
                        )}
                ...
                <FormField
                  ...
                  name="acceptTerms"
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-lg border border-[#202833] p-4 bg-[#111720]/40">
                      <FormControl>
                        <input
                          type="checkbox"
                          id="acceptTerms"
