...
import { Cpu, Eye, EyeOff, Loader2, Shield, Lock, Activity, Users } from "lucide-react";
  ...
  return (
    <GuestRoute>
      <div className="flex h-screen w-full bg-[#090B0F] text-[#F5F7FA] overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center px-6 lg:px-12 py-10 z-10 overflow-y-auto">
          <Card className="w-full max-w-md border border-[#202833] bg-[#0D1117] shadow-2xl">
            <CardHeader className="text-center pb-3">
              <Link href="/" className="flex items-center justify-center space-x-2.5 mb-3 group">
        ...
        {/* Right Side: Product Preview & Trust Indicators */}
          ...
          <div className="max-w-xl space-y-8 z-10">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-extrabold tracking-tight text-[#F5F7FA] font-sans">
                Build Enterprise AI Software with Autonomous Agents
              </h2>
              <p className="text-[#9CA6B5] text-sm leading-relaxed">
                ASEP provides secure sandbox execution environments, fine-grained multi-tenant isolation policies, and detailed audit logging pipelines to govern mission-critical engineering agents.
              </p>
            </div>

            {/* Interactive/static visual mockup of dashboard telemetry */}
            <div className="border border-[#202833] bg-[#090B0F] rounded-lg p-5 font-mono text-[10px] space-y-4 shadow-xl">
              <div className="flex justify-between items-center border-b border-[#202833] pb-2 text-[#667085]">
                <span className="flex items-center gap-1.5"><Activity className="h-3.5 w-3.5 text-[#22D3EE]" />SYSTEM TELEMETRY</span>
                <span className="text-[#2DD4A3] bg-[#2DD4A3]/10 px-2 py-0.5 rounded border border-[#2DD4A3]/20">ACTIVE</span>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-2.5 rounded border border-[#202833] bg-[#0D1117]">
                  <span className="text-[#667085] uppercase block">Engine Load</span>
                  <span className="text-sm font-bold text-[#F5F7FA] mt-0.5">8.4%</span>
                </div>
                <div className="p-2.5 rounded border border-[#202833] bg-[#0D1117]">
                  <span className="text-[#667085] uppercase block">Active Threads</span>
                  <span className="text-sm font-bold text-[#F5F7FA] mt-0.5">18</span>
                </div>
              </div>
              <div className="p-3 bg-[#0D1117] border border-[#202833] rounded flex items-center justify-between">
                <span className="text-[#9CA6B5] flex items-center gap-2"><Lock className="h-3.5 w-3.5 text-[#22D3EE]" />Data Encryption Mode</span>
                <span className="text-[#2DD4A3]">AES-256</span>
              </div>
            </div>

            <div className="border-t border-[#202833] pt-6 flex items-center gap-3">
              <div className="h-9 w-9 rounded bg-[#111720] border border-[#202833] flex items-center justify-center text-[#22D3EE]">
                <Users className="h-4 w-4" />
              </div>
              <div>
                <p className="text-xs font-mono text-[#F5F7FA]">&quot;ASEP is the first platform that makes autonomous agents reliable at scale.&quot;</p>
                <p className="text-[10px] font-mono text-[#667085] mt-0.5">— Principal AI Architect, CloudCorp</p>
              </div>
            </div>
          </div>
        </div>
