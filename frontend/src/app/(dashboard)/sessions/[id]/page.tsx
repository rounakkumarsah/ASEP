    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="destructive" size="sm">Halt Execution</Button>
        </div>
      </div>
          ...
          <Card className="flex flex-col h-[500px]">
            <CardHeader className="border-b border-border/50 pb-4">
              <CardTitle className="flex items-center gap-2 text-lg">
                <TerminalSquare className="h-5 w-5 text-primary" /> Execution Timeline
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0 flex-1 bg-muted/20 relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-muted-foreground p-8 text-center">
                ...
                <h3 className="font-semibold text-foreground mb-1">Live streaming not yet connected</h3>
                <p className="text-sm max-w-sm">
                  In a future phase, this area will stream live execution logs, agent reasoning traces, and standard output.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="pt-5">
              <div className="flex justify-between items-end mb-2">
                <span className="text-3xl font-bold tracking-tighter">{session.progress}%</span>
                <span className="text-sm font-medium text-primary mb-1">{session.stage}</span>
              </div>
            ...
            <CardContent className="pt-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Operating autonomously</p>
                </div>
              </div>
            </CardContent>
          </Card>
