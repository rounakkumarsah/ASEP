...
import { Server, Database, Package, Code2, Network, Braces, Quote, User } from "lucide-react"
          ...
          >
            ...
            <div className="relative rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-8 shadow-2xl">
              ...
              <blockquote className="text-xl leading-relaxed text-muted-foreground italic mb-6">
                &quot;Early access feedback and customer testimonials will appear here once the platform moves into the next phase of deployment.&quot;
              </blockquote>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="font-semibold text-foreground">Early Adopter</div>
                  <div className="text-sm text-muted-foreground">Engineering Leader</div>
                </div>
              </div>
            </div>
          </motion.div>
