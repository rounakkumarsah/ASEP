...
const mockKnowledge: KnowledgeDocument[] = [
  {
    ...
    snippet:
      "The v2 protocol requires RS256 signing for all JWT tokens issued by the core auth service. Refresh tokens are valid for 7 days.",
  ...
  },
  {
    ...
    snippet:
      "All agent microservices must define resource limits. Specifically, CPU limits should be set to 500m and Memory to 1Gi.",
  ...
  },
  {
    ...
    snippet:
      "User inputs must be sanitized through the primary LLM firewall before being passed to the executor agent. Disallow standard system overrides.",
